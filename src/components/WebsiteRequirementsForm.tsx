        ...
        {[1, 2, 3, 4, 5].map((s) => (
          <div key={s} className="flex items-center">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${
              step === s ? 'bg-primary text-white' : step > s ? 'bg-emerald-500 text-white' : 'bg-slate-200 text-slate-500'
            }`}>
      ...
      <div className="p-8">
        ...
        {step === 3 && (
          <div className="space-y-8">
            ...
            {renderBilingualInput("Our Mission", formData.aboutUs.mission, (lang, val) => setFormData({...formData, aboutUs: {...formData.aboutUs, mission: {...formData.aboutUs.mission, [lang]: val}}}, true))}
            {renderBilingualInput("Our Vision", formData.aboutUs.vision, (lang, val) => setFormData({...formData, aboutUs: {...formData.aboutUs, vision: {...formData.aboutUs.vision, [lang]: val}}}, true))}
