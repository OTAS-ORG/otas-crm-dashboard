      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          <div>
            ...
            {clientId && (
              <div className="text-sm text-slate-500 mt-1 h-5 flex items-center">
                {isFetching ? (
                  <span className="w-48 h-4 bg-slate-200 rounded animate-pulse"></span>
                ) : (
                  <>
        ...
        {/* Tabs */}
        {clientId && (
          <div className="flex gap-1 px-6 py-2 border-b border-slate-100 bg-slate-50/30">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 relative">
          {isFetching ? (
            <div className="flex flex-col items-center justify-center h-full min-h-[400px]">
              <div className="w-12 h-12 border-primary/20 border-t-primary rounded-full animate-spin mb-4"></div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-8">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              type="text"
                              disabled={isViewMode}
                              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-800 font-medium disabled:bg-white disabled:border-transparent disabled:cursor-default disabled:opacity-100"
                        ...
                        <div>
                          ...
                          <select
                            disabled={isViewMode}
                            className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-800 font-medium disabled:bg-white disabled:border-transparent disabled:cursor-default disabled:opacity-100"
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          ...
                          {client.backgroundNote && (
                            <button
                              ...
                              className="flex items-center gap-1 text-[10px] font-bold text-primary hover:text-primary-800 transition-colors uppercase tracking-wider"
                            >
                        ...
                        >
                          <textarea
                            ...
                            className={`w-full px-4 py-3 rounded-xl transition-all text-slate-800 font-medium resize-none ${isViewMode ? "bg-white border-transparent cursor-pointer" : "bg-slate-50 border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"}`}
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <select
                          disabled={isViewMode}
                          className={`w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-900 font-bold disabled:bg-white disabled:border-transparent disabled:cursor-default disabled:opacity-100 ${client.status === "Signed" ? "text-emerald-700 bg-emerald-50 border-emerald-200 focus:border-emerald-500 focus:ring-emerald-500/20" : ""}`}
                          value={client.status}
                          onChange={(e) =>
                            setClient({
                              ...client,
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div className="space-y-5">
                            <div>
                              ...
                              <input
                                ...
                                type="text"
                                disabled={isViewMode}
                                className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-slate-800 font-medium shadow-sm disabled:bg-white disabled:border-transparent disabled:cursor-default disabled:opacity-100"
                          ...
                          <div>
                            ...
                            <textarea
                              rows={5}
                              disabled={isViewMode}
                              className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-slate-800 font-medium resize-none shadow-sm disabled:bg-white disabled:border-transparent disabled:cursor-default disabled:opacity-100"
                    ...
                    <div className="flex gap-3">
                      {isViewMode ? (
                        <button
                          ...
                          className="px-8 py-2.5 bg-primary text-white rounded-xl font-bold hover:bg-primary-700 hover:shadow-lg hover:shadow-primary/20 transition-all active:scale-95 flex items-center"
                        >
                        ...
                        <>
                          <button
                            ...
                            disabled={loading}
                            className="px-6 py-2.5 border border-slate-200 rounded-xl text-slate-600 font-bold hover:bg-slate-50 hover:text-slate-900 transition-all"
                          >
                            Cancel
                          </button>
                          <button
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-primary text-white rounded-lg font-bold hover:bg-primary-700 transition-colors"
                      >
                        Add
                      </button>
                    </div>
                    ...
                    {client.conversationLogs?.length ? (
                      client.conversationLogs
                        ...
                        .map((log, i) => (
                          <div
                            key={i}
                            className="flex gap-4 p-4 bg-white border border-slate-100 rounded-xl shadow-sm"
                          >
                        ...
                        <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded border border-slate-200 bg-white shadow">
                          <div className="flex items-center justify-between space-x-2 mb-1">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <time className="font-medium text-primary text-xs">
